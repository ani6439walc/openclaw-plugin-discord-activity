...
- Root tree connectors begin under the first text character after the header emoji and separating space. Nested connectors and continuation lines preserve their relative indentation from that root prefix.
